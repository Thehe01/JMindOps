package com.kama.jmindops.agent.examples;

import com.kama.jmindops.agent.tools.test.CityTool;
import com.kama.jmindops.agent.tools.test.DateTool;
import com.kama.jmindops.agent.tools.test.WeatherTool;
...
public class JMindOpsV2Test {
    ...
    public void testToolCalling() {
        ...
        // 创建 V2 实例
        JMindOpsV2 agent = new JMindOpsV2(
                "test-agent-v2",
                "测试 Agent V2",
