...
public class DocumentController {
    ...
    public DocumentController(DocumentFacadeService documentFacadeService) {
        this.documentFacadeService = documentFacadeService;
    }
    ...
    public ApiResponse<Void> updateDocument(@PathVariable String documentId, @Valid @RequestBody UpdateDocumentRequest request) {
