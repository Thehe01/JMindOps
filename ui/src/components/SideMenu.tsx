...
const SideMenu: React.FC<SideMenuProps> = () => {
  ...
  const activeKey = (() => {
    if (routeLocation.pathname.startsWith("/agent")) return "agent";
    if (routeLocation.pathname.startsWith("/knowledge-base")) {
      ...
      children: (
        <AgentTabContent
          ...
          onSelectAgent={(selectedAgentId) => {
            navigate("/chat", { state: { selectedAgentId } });
          }}
    ...
    },
    {
      ...
      children: (
        <KnowledgeBaseTabContent
          ...
          loading={knowledgeBasesLoading}
          error={knowledgeBasesError}
          onRetry={() => void refreshKnowledgeBases()}
